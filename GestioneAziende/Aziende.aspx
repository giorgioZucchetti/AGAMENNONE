            ...
            <div class="col">
                ...
                <div class="card-footer text-center">
                    ...
                    <asp:UpdatePanel ID="up1" runat="server">
                        <contenttemplate>
                            <asp:Button ID="btnInserisci" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalIns" runat="server" data-bs-backdrop="static" runat="server" Text="Inserisci"  />
                            <asp:Button ID="btnModifica" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalMod" runat="server" data-bs-backdrop="static" runat="server" Text="Modifica" />
                        </contenttemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" runat="server">
                    <div class="ratio ratio-1x1">
                        <iframe style="width: 100%" src="InsAziendePopUp.aspx"></iframe>
                    </div>
                </div>
    ...
    <div class="modal" id="modalMod" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" runat="server">
                    <div class="ratio ratio-1x1">
                        <iframe style="width: 100%" src="ModAziendePopUp.aspx"></iframe>
                    </div>
                </div>
