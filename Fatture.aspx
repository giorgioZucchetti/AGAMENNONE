<%@ Page Title="" Language="C#" MasterPageFile="~/AGAMENNONE.master" AutoEventWireup="true" CodeFile="Fatture.aspx.cs" Inherits="Default2" %>
            ...
            <div class="col-12 mx-auto">
                <div class="card bg-light mb-3 border rounded">
                    <div class="card-header">
                        <h5 class="card-title">Lista Fatture</h5>
                    </div>
                    <div class="card-body">
