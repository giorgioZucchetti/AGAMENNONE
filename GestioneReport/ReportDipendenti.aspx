<%@ Page Title="" Language="C#" MasterPageFile="~/AGAMENNONE.master" AutoEventWireup="true" CodeFile="ReportDipendenti.aspx.cs" Inherits="_Default" %>
            ...
            <div class="col-12 mx-auto">
                <div class="card bg-light mb-3 border rounded" style="background-color: #e4e4e4">
                    <div class="card-header">
                        <h5 class="card-title">Report per Dipendenti e Commesse</h5>
                    </div>
                    <div class="card-body">
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5>
                                            <asp:Label ID="Label1" runat="server" Text="Seleziona elementi"></asp:Label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="Label6" runat="server" Text="Dipentente"></asp:Label>
                                        <asp:DropDownList ID="ddlDipendente" class="btn btn-outline-primary" runat="server"></asp:DropDownList>


                                    </div>
                                    <div class="col-md-6">
                                        <asp:Label ID="Label7" runat="server" Text="Commessa"></asp:Label>
                                        <asp:DropDownList ID="ddlCommessa" class="btn btn-outline-primary" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
