<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POPUP_CLIENTI_Update.aspx.cs" Inherits="POPUP_CLIENTI_Update" %>
   ...
   <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="text-center mt-2">
                <asp:Button ID="btnModifica" type="button" runat="server" Text="Modifica" class="btn btn-primary" OnClick="btnModifica_Click" />
            </div>
